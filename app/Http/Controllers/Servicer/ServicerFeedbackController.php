...
class ServicerFeedbackController extends Controller
{
    ...
    {
        $feedbacks = Feedback::select('tbl_feedback.description', 'tbl_feedback.rate_point', 'tbl_feedback.like_count', 'tbl_feedback.created_at', 'tbl_client.username', 'tbl_client.profile_image', 'tbl_svc_category.svc_name')
