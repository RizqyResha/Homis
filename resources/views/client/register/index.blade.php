...
<body>
    <div class="grid lg:grid-cols-2 grid-rows-none">
            ...
            <div class="w-full lg:max-w-lg">
                <div class="p-6 space-y-5 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" action="/client/login" method="POST">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input name="nama_depan" placeholder="" :type="text"
                            ...
                            <div>
                                ...
                                <input name="nama_belakang" placeholder="" :type="text"
                                    class="text-md block px-3 py-2 rounded-lg w-full bg-white border-2 border-gray-300 placeholder-gray-600 shadow-md focus:placeholder-gray-500 focus:bg-white focus:border-gray-600 focus:outline-none">
                                @error('nama_belakang')
                                <div class="text-sm text-red-600">{{ $message }}</div>
                                @enderror
                        ...
                        <div>
                            ...
                            <div id="jk" class="flex grid grid-cols-2">
                                <div class="inline-flex items-center">
                                  ...
                                  <label class="mt-px cursor-pointer select-none font-light text-gray-700" for="jenis_kelamin" > Male </label>
                                </div>
                                <div class="inline-flex items-center">
                                  <label class="relative flex cursor-pointer items-center rounded-full p-3" for="react" data-ripple-dark="true" >
                                    <input id="react" name="jenis_kelamin" type="radio" class="before:content[''] peer relative h-5 w-5 cursor-pointer appearance-none rounded-full border-2 border-dark-300 text-green-500 transition-all before:absolute before:top-2/4 before:left-2/4 before:block before:h-12 before:w-12 before:-translate-y-2/4 before:-translate-x-2/4 before:rounded-full before:bg-blue-gray-500 before:opacity-0 before:transition-opacity checked:border-green-500 checked:before:bg-green-500 hover:before:opacity-10 "/>
                                    <div class="pointer-events-none absolute top-2/4 left-2/4 -translate-y-2/4 -translate-x-2/4 text-green-500 opacity-0 transition-opacity peer-checked:opacity-100">
                                      <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" viewBox="0 0 16 16" fill="currentColor" >
                                        <circle data-name="ellipse" cx="8" cy="8" r="8"></circle>
                                      </svg>
                                  ...
                                  <label class="mt-px cursor-pointer select-none font-light text-gray-700" for="react"> Female  </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <button
                            class="px-4 py-2 w-full text-lg font-semibold text-sm bg-green-500 text-white rounded-none shadow-sm"
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        <a href=""><button
                                class="px-4 py-2 w-full bg-white border border-gray-300 flex justify-center"><img
                                    src="{{ asset('assets/img/client/login/google.png') }}" class="" alt="" width="30px"
                                    srcset=""></button></a>
                        <a href=""><button
                                class="px-4 py-2 w-full bg-white border border-gray-300 flex justify-center"><img
                                    src="{{ asset('assets/img/client/login/fb2.png') }}" class="" alt="" width="30px"
                                    srcset=""></button></a>
                        <a href=""><button
                                class="px-4 py-2 w-full bg-white border border-gray-300 flex justify-center"><img
                                    src="{{ asset('assets/img/client/login/twt2.png') }}" class="" alt="" width="30px"
                                    srcset=""></button></a>
                    </div>
        ...
        <div class="visible items-end grid lg:grid-cols-3 lg:visible sm:invisible md:invisible xs:invisible ssm:invisible sxm:invisible xxm:invisible">
            <div></div>
            <div class="xl:col-span-2 lg:col-span-3 lg:bg-no-repeat h-full w-full bg-cover" style="background-image: url({{ asset('assets/img/client/register/Dis-2.png') }})"></div>
        </div>
    </div>
</body>
