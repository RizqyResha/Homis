...
<body class="m-0 font-sans text-base antialiased font-normal dark:bg-slate-900 leading-default bg-gray-50 text-slate-500">
    ...
    <div fixed-plugin>
        ...
        <a href="javascript:;" fixed-plugin-button class="fixed ease-nav-brand px-4 py-2 text-xl bg-white shadow-lg cursor-pointer bottom-8 right-8 z-990 rounded-circle text-slate-700" sidenav-trigger>
            <i class="py-2 pointer-events-none fa fa-cog"> </i>
        </a>
        <li class="sticky top-10 flex items-center pl-4 xl:hidden">
