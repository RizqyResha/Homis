<!-- Navbar -->
<nav class="bg-white border-gray-200 xl:ml-5 xl:rounded dark:bg-gray-900 pr-10 pl-10 ease-in" navbar-main navbar-scroll="false">
    <div class="max-w-screen-xl xl:mt-5 flex flex-wrap items-center justify-between mx-auto p-2">
        ...
        <a href="javascript:;" sidenav-trigger class="xl:hidden transition-all ease-nav-brand fixed px-4 py-2 text-xl bg-white shadow-lg cursor-pointer bottom-8 right-8 z-990 rounded-circle text-slate-700">
            <i class="py-2 pointer-events-none fa fa-cog"> </i>
        </a>
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <li class="flex items-center pl-4 ">

                {{-- <a href="javascript:;" class="block p-0 text-sm text-green-500 transition-all ease-nav-brand" sidenav-trigger>
                    <div class="w-4.5 overflow-hidden">aaaaaaaaaaa
            ...
            <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                <li>
                    <a href="{{ route('client.search') }}" class="mt-2 block py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-green-700 md:p-0 dark:text-white md:dark:hover:text-green-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Search</a>
                </li>
                <li>
