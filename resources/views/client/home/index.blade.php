                        ...
                        <div class=" bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <div class="p-5">
                                <a href="{{ route('client.search.category', ['category' => $row->svc_category_name]) }}">
                                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-700 dark:text-white">{{ $row->svc_category_name }}</h5>
                                </a>
                                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">{{ $row->svc_description }}</p>
                                <a href="{{ route('client.search.category', ['category' => $row->svc_category_name]) }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-green-700 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                                    Explore
