...
<body class="w-full h-full bg-no-repeat bg-cover" style="background-image: url({{ asset('assets/img/admin/login/bg.png') }})">
    <div class="grid lg:grid-cols-2 grid-rows-none">
        <div class="visible grid lg:grid-cols-3 lg:visible sm:invisible md:invisible xs:invisible ssm:invisible sxm:invisible xxm:invisible">
            <div class="lg:col-span-2 lg:bg-no-repeat lg:h-screen lg:w-full bg-cover" style="background-image: url({{ asset('assets/img/admin/login/all3.png') }})"></div>
        </div>
        <div class="grid grid-cols-1">
            <div class="w-full lg:max-w-lg">
                <div class="p-6 space-y-5 md:space-y-6 sm:p-8">
                    <img src="{{ asset('assets/img/admin/login/logo.png') }}" alt="" width="160px" srcset="">
                    ...
                    <form class="space-y-4 md:space-y-6" action="#">
                        ...
                        <div class="py-2" x-data="{ show: true }">
                            ...
                            <div class="relative">
                                <input placeholder="" :type="show ? 'password' : 'text'" class="text-md block px-3 py-2 rounded-lg w-full bg-white border-2 border-gray-300 placeholder-gray-600 shadow-md focus:placeholder-gray-500 focus:bg-white focus:border-gray-600 focus:outline-none">
                    ...
                    <button class="px-4 py-2 w-full text-lg font-semibold text-sm bg-green-500 text-white rounded-none shadow-sm">Sign In</button>

                    <p class="text-gray-500 text-center">Login with</p>
                    <div class="grid grid-cols-3 gap-4">
                        <button class="px-4 py-2 w-full bg-white border border-gray-300 flex justify-center"><img src="{{ asset('assets/img/admin/login/google.png') }}" class="" alt="" width="30px" srcset=""></button>
                        <button class="px-4 py-2 w-full bg-white border border-gray-300 flex justify-center"><img src="{{ asset('assets/img/admin/login/fb2.png') }}" class="" alt="" width="30px" srcset=""></button>
                        <button class="px-4 py-2 w-full bg-white border border-gray-300 flex justify-center"><img src="{{ asset('assets/img/admin/login/twt2.png') }}" class="" alt="" width="30px" srcset=""></button>
                    </div>
