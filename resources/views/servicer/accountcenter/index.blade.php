    ...
    <div class="-mx-3">
        <div class="flex-none px-3">
            <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-xl dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl bg-clip-border">
                ...
                <form action="{{ route('servicer.accountcenter.edit') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                                    ...
                                    <span class="flex items-center space-x-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-gray-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                            @if ($data->profile_image == 'noimage')
                                                <img src="{{ url('assets/img/servicer/profile-img/noimage.png') }}" width="150" class="img-thumbnail mr-3" align="left" id="preview">
                                            @else
                                                <img src="{{ url('assets/img/servicer/profile-img/' . $data->profile_image) }}" width="150" class="img-thumbnail mr-3" align="left" id="preview">
                                            @endif
