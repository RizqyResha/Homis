...
<head>
    ...
    <title>Homis | Servicer Join</title>
...
<body>
    <div class="grid lg:grid-cols-2 grid-rows-none">
        <div class="grid grid-cols-1 lg:px-24">
            <div class="w-full lg:max-w-lg">
                <div class="p-6 space-y-5 md:space-y-6 sm:p-8">
                    ...
                    @endif
                    <form class="space-y-4 md:space-y-6" action="{{ route('servicer.register.process') }}" method="POST">
                        @csrf
        ...
        <div class="md:items-end visible grid lg:grid-cols-3 lg:visible sm:invisible md:invisible xs:invisible ssm:invisible sxm:invisible xxm:invisible">
            <div></div>
            <div class="xl:col-span-2 lg:col-span-2 lg:bg-no-repeat lg:h-screen w-full bg-cover" style="background-image: url({{ asset('assets/img/servicer/register/Dis-2.png') }})"></div>
        </div>
    </div>
</body>
