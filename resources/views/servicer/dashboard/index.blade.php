...
<head>
    ...
    <script src="https://kit.fontawesome.com/ef9295bcb5.js" crossorigin="anonymous"></script>
    <!-- Main Styling -->
                                    ...
                                    <div>
                                        ...
                                        <div class="">
                                            <div class="flex items-center mt-1 mb-1">
                                                <svg aria-hidden="true" class="w-6 h-6 text-yellow-400 text-gray-300 dark:text-gray-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="relative flex flex-col min-w-0 break-words bg-white shadow-xl dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl bg-clip-border">
                        <div class="flex-auto p-4">
                            <div class="flex flex-row -mx-3">
                                <div class="flex-none w-2/3 max-w-full px-3">
                                    <div>
                                        <p class="mb-0 font-sans text-sm font-semibold leading-normal uppercase dark:text-white dark:opacity-60">Total Earnings</p>
                    ...
                    <div class="relative flex flex-col min-w-0 break-words bg-white border-0 border-solid shadow-xl dark:bg-slate-850 dark:shadow-dark-xl dark:bg-gray-950 border-black-125 rounded-2xl bg-clip-border">
                        ...
                        <div class="p-5">
                            ...
                            <div class="flex items-center mb-1">
                                <svg aria-hidden="true" class="w-5 h-5 text-yellow-400 text-gray-300 dark:text-gray-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <title>First star</title>
                                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
                                </svg>
                                <svg aria-hidden="true" class="w-5 h-5 text-yellow-400 text-gray-300 dark:text-gray-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="flex items-center space-x-4 ">
                                ...
                                <div class="dark:text-white">
                                    <div class="Font Bold">Jese Leos</div>
                                    <div class="text-sm text-gray-500 dark:text-gray-400">Room Bliss</div>
                                </div>
                            </div>

                            <div>
                                <small>6/29/2023 11:32 PM</small>
                            </div>
                            <div class="">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur voluptatibus aut corrupti voluptatum, est facere ullam iure ad fugiat cumque. Voluptate, libero. Numquam consequuntur temporibus ipsa atque dolorum itaque voluptatibus.
                            </div>
                            <hr>
                            <div class=""><i class="fas fa-thumbs-up mb-6 mt-2"></i> 12983</div>
                                ...
                                <li class="relative flex justify-between py-2 pr-4 border-0 rounded-b-lg rounded-xl text-inherit">
                                    <div class="flex items-center">
                                        ...
                                        <div class="flex flex-col">
                                            <h6 class="mb-1 text-sm leading-normal text-slate-700 dark:text-white">Room Bliss</h6>
                                        </div>
                                    </div>
                                    <div class="flex">
