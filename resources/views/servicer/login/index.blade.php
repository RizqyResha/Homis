...
<head>
    ...
    <title>Homis | Servicer Login</title>
    @vite('resources/css/app.css')
</head>

<body class="w-full h-screen bg-no-repeat bg-cover" style="background-image: url({{ asset('assets/img/servicer/login/bg.png') }})">
    <div class="grid lg:grid-cols-2 grid-rows-none">
        <div class="visible grid lg:grid-cols-3 lg:visible sm:invisible md:invisible xs:invisible ssm:invisible sxm:invisible xxm:invisible">
            <div class="xl:col-span-2 lg:col-span-3 lg:bg-no-repeat lg:h-screen w-full bg-cover" style="background-image: url({{ asset('assets/img/servicer/login/all3.png') }})"></div>
        </div>
        <div class="grid grid-cols-1">
            <div class="w-full lg:max-w-lg">
                <div class="p-6 space-y-5 md:space-y-6 sm:p-8">
                    ...
                    @endif
                    <form class="space-y-4 md:space-y-6" action="{{ route('servicer.login.process') }}" method="POST">
                        @csrf
                        <div>
