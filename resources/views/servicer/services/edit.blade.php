    ...
    <div class="-mx-3">
        <div class="flex-none px-3">
            <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-xl dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl bg-clip-border">
                ...
                <form action="{{ route('servicer.service.edit.process') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="grid xl:grid-cols-3 mt-5 p-5 gap-4">
                                    ...
                                    <span class="flex items-center space-x-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-gray-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                            @if ($data->thumbnail_image != 'noimage')
                                                <img src="{{ url('assets/img/services/' . $data->thumbnail_image) }}" width="150" class="img-thumbnail mr-3" align="left" id="preview">
                                            @else
                        ...
                        <div class="grid xl:grid-rows-3 xl:col-span-2">
                            <div class="relative z-0 w-full mb-6 group p-2">
                                <input type="hidden" name="id_svc" value="{{ $id_svc }}" id="" class="hidden" hidden>
                                <input value="{{ $data->svc_name }}" type="text" name="svc_name" id="svc_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                            ...
                            <div class="relative z-0 w-full mb-6 group p-2">
                                <input value="{{ $data->svc_category_name }}" type="text" name="svc_category_name" id="svc_category_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                            ...
                            <div class="relative col-span-2 z-0 w-full mb-6 group p-2">
                                <input value="{{ $data->description }}" type="text" name="description" id="description" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                                <label for="description" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Description</label>
                            </div>

                            <div class="relative z-0 w-full mb-6 group p-2">
                                <input value="{{ $hourly->price_per_period }}" type="number" name="hourly" id="hourly" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                            ...
                            <div class="relative z-0 w-full mb-6 group p-2">
                                <input value="{{ $daily->price_per_period }}" type="number" name="daily" id="daily" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                            ...
                            <div class="relative z-0 w-full mb-6 group p-2">
                                <input value="{{ $weekly->price_per_period }}" type="number" name="weekly" id="weekly" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                            ...
                            <div class="relative z-0 w-full mb-6 group p-2">
                                <input value="{{ $monthly->price_per_period }}" type="number" name="monthly" id="monthly" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
